...
describe('Reset Dancers Functionality', () => {
  ...
  test('resetDancers creates initial state with one panel and two dancers', () => {
    ...
    expect(dancer1.y).toBe(210); // Canvas center - dancer offset
    ...
    expect(dancer2.y).toBe(390); // Canvas center + dancer offset
  ...
  test('resetDancers works when starting from modified state', () => {
    ...
    expect(resetPanel.dancers[0].y).toBe(210); // Canvas center - dancer offset
